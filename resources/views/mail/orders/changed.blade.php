@component('mail::message')
    ...
    $content = str_replace('::customer_name::',($order->shippingAddress)?$order->shippingAddress->full_name:'', $content);
    $content = str_replace('::customer_phone::',($order->shippingAddress)?$order->shippingAddress->phone:'', $content);
    $content = str_replace('::customer_email::',$order->user->email, $content);
